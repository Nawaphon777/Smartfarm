      ...
      <v-main style="height: auto; width: auto;">
        ...
        <v-card color="grey-lighten-4" flat height="auto" rounded="0" justify="center">
          <v-toolbar density="compact"
            ...
            <h2 style="font-size: 20px;  font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; ">
              Dashboard</h2>
            <v-spacer></v-spacer>
            <h3 style="margin-right: 20px; font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; font-size: 20px;">
              {{ currentTime }}</h3>
          </v-toolbar>
        </v-card>
        <!-- END HEADER ===================================================================== -->
        ...
        <v-row style="display: flex; flex-wrap: wrap;">
          ...
          <v-col style="justify-items: center;">
            <v-row
              style="height: 500px; width: 400px; align-items: top;border-radius: 50px; justify-content: center; margin:40px auto; padding: 20px;">
              <v-col style="align-items: center; margin-top: 40px ;">
                <div class="circular-frame">
                  <v-card class="pH-value-card" outlined rounded-xl>
                    <a style="text-align: center; font-size:40px; margin: 90px; font-family: ; color: #1f1183;">pHvalue</a>
                    <!-- pH Value Progress Circular -->
                    <v-progress-circular :rotate="0" :size="300" :width="75" :model-value="value3" color="#1f1183"
                      style="margin: 20px 20px 20px 20px; font-family:; font-size:40px;">
                      {{ value3 }} pH
                    </v-progress-circular>
                  </v-card>
                </div>
          ...
          <v-row style="align-items: center; margin-bottom: 20px;">
            <v-col style="justify-items: center;">
              
              <v-row
                style="height: 500px; width: 430px; align-items: center; background-color: #f3f3f3; justify-content: center;  border-radius: 50px; margin: 50px auto; padding: 10px;">
                <a style="text-align: center; font-size:40px;  font-family: ;color: #1f1183;">pump control</a>
                <!-- Button 2 -->
            ...
            <v-col style="justify-items: center;">
              <v-row
                style="height: 500px; width: 430px; align-items: center; background-color: #f3f3f3; justify-content: center;  border-radius: 50px; margin: 50px auto; padding: 10px;">
                <a style="text-align: center; font-size:40px;  font-family: ;color: #1f1183;">Solinoi control</a>
                <!-- Button 2 -->
